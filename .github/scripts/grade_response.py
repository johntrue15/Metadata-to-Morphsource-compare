...
Respond ONLY with the JSON object, no other text."""
        ...
        print("📊 Grading response with ChatGPT...")

        system_msg = "You are an expert evaluator for database query responses. "
        system_msg += "Always respond with valid JSON only."
        ...
        try:
            ...
            print(f"✓ Grade: {grade_data['overall_grade']}/100")
            ...
            print(f"✗ Failed to parse grade response: {e}")
    ...
    if 'GITHUB_OUTPUT' in os.environ:
        with open(os.environ['GITHUB_OUTPUT'], 'a') as f:
            if grade_result.get('status') == 'success':
                ...
                f.write("grade=0\n")
                error_msg = grade_result.get('message', 'Unknown error')
                f.write(f"reasoning=Error: {error_msg}\n")
