#!/usr/bin/env bash
# Reproduction script for run 20260530T220507Z_oceanites_skull_000S29911_fresh_0ea081.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume oceanites_skull_000S29911_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T220507Z_oceanites_skull_000S29911_fresh_0ea081 \
    --label "oceanites_skull_000S29911_fresh"
