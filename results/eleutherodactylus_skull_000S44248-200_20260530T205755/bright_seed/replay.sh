#!/usr/bin/env bash
# Reproduction script for run 20260530T205759Z_eleutherodactylus_skull_000S44248_fresh_e22db8.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume eleutherodactylus_skull_000S44248_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T205759Z_eleutherodactylus_skull_000S44248_fresh_e22db8 \
    --label "eleutherodactylus_skull_000S44248_fresh"
