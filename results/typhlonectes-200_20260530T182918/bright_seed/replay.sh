#!/usr/bin/env bash
# Reproduction script for run 20260530T182922Z_typhlonectes_skull_000649626_fresh_c612ea.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume typhlonectes_skull_000649626_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T182922Z_typhlonectes_skull_000649626_fresh_c612ea \
    --label "typhlonectes_skull_000649626_fresh"
