#!/usr/bin/env bash
# Reproduction script for run 20260530T181816Z_chameleon_skull_000408235_fresh_f2767f.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume chameleon_skull_000408235_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T181816Z_chameleon_skull_000408235_fresh_f2767f \
    --label "chameleon_skull_000408235_fresh"
