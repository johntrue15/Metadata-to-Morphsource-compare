#!/usr/bin/env bash
# Reproduction script for run 20260530T204506Z_desmodus_skull_000S44285_fresh_2442e7.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume desmodus_skull_000S44285_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T204506Z_desmodus_skull_000S44285_fresh_2442e7 \
    --label "desmodus_skull_000S44285_fresh"
