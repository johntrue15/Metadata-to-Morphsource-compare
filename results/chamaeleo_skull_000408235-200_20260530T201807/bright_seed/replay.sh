#!/usr/bin/env bash
# Reproduction script for run 20260530T201810Z_chamaeleo_skull_000408235_fresh_9a5f0b.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume chamaeleo_skull_000408235_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T201810Z_chamaeleo_skull_000408235_fresh_9a5f0b \
    --label "chamaeleo_skull_000408235_fresh"
