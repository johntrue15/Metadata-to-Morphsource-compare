#!/usr/bin/env bash
# Reproduction script for run 20260530T171500Z_crotalus_skull_000445108_fresh_51bb3b.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume crotalus_skull_000445108_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T171500Z_crotalus_skull_000445108_fresh_51bb3b \
