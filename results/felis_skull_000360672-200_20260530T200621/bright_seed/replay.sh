#!/usr/bin/env bash
# Reproduction script for run 20260530T200624Z_felis_skull_000360672_fresh_89083e.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume felis_skull_000360672_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T200624Z_felis_skull_000360672_fresh_89083e \
    --label "felis_skull_000360672_fresh"
