#!/usr/bin/env bash
# Reproduction script for run 20260530T211333Z_eunectes_skull_000S10037_fresh_1ab3be.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume eunectes_skull_000S10037_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T211333Z_eunectes_skull_000S10037_fresh_1ab3be \
    --label "eunectes_skull_000S10037_fresh"
