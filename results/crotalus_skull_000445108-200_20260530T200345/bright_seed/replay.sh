#!/usr/bin/env bash
# Reproduction script for run 20260530T200348Z_crotalus_skull_000445108_fresh_70a0d9.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume crotalus_skull_000445108_ct_1 \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T200348Z_crotalus_skull_000445108_fresh_70a0d9 \
    --label "crotalus_skull_000445108_fresh"
