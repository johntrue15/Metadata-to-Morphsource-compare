#!/usr/bin/env bash
# Reproduction script for run 20260529T192610Z_tuatara_skull_000358663_fresh_3f9190.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    ...
    --reset-first \
    --no-stop-rules \
    --out-dir runs/replay_20260529T192610Z_tuatara_skull_000358663_fresh_3f9190 \
    --label "tuatara_skull_000358663_fresh"
