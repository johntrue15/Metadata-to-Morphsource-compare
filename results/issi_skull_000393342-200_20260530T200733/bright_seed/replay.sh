#!/usr/bin/env bash
# Reproduction script for run 20260530T200737Z_issi_skull_000393342_fresh_707a23.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume issi_skull_000393342_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T200737Z_issi_skull_000393342_fresh_707a23 \
    --label "issi_skull_000393342_fresh"
