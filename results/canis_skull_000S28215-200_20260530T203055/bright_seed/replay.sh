#!/usr/bin/env bash
# Reproduction script for run 20260530T203059Z_canis_skull_000S28215_fresh_6c6fee.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume canis_skull_000S28215_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T203059Z_canis_skull_000S28215_fresh_6c6fee \
    --label "canis_skull_000S28215_fresh"
