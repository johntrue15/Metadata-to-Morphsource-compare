#!/usr/bin/env bash
# Reproduction script for run 20260531T134155Z_phyllurus_skull_000362039_fresh_dff67a.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume phyllurus_skull_000362039_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260531T134155Z_phyllurus_skull_000362039_fresh_dff67a \
    --label "phyllurus_skull_000362039_fresh"
