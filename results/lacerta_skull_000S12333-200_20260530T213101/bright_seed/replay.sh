#!/usr/bin/env bash
# Reproduction script for run 20260530T213105Z_lacerta_skull_000S12333_fresh_db64d7.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume lacerta_skull_000S12333_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260530T213105Z_lacerta_skull_000S12333_fresh_db64d7 \
    --label "lacerta_skull_000S12333_fresh"
