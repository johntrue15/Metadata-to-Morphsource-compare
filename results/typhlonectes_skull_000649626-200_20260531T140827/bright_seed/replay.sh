#!/usr/bin/env bash
# Reproduction script for run 20260531T140831Z_typhlonectes_skull_000649626_fresh_b87dfa.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260531T140831Z_typhlonectes_skull_000649626_fresh_b87dfa \
