#!/usr/bin/env bash
# Reproduction script for run 20260531T161819Z_gekko_skull_000S27997_fresh_4be33f.
...
python3 ".github/scripts/slicer_remote_bright_seed.py" \
    --volume gekko_skull_000S27997_ct \
    ...
    --batch-size 8 \
    --headless \
    --out-dir runs/replay_20260531T161819Z_gekko_skull_000S27997_fresh_4be33f \
    --label "gekko_skull_000S27997_fresh"
